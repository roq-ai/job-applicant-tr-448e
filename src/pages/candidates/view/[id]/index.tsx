...
function CandidateViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CandidateInterface>(
    ...
    () =>
      getCandidateById(id, {
        relations: ['job_posting', 'note', 'recommendation'],
      }),
  );
              ...
              {hasAccess('note', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/notes/create?candidate_id=${data?.id}`}>
              ...
              {hasAccess('recommendation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/recommendations/create?candidate_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
